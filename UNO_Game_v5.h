...
//    8. static members use C++17 inline static (no separate .cpp needed)
//    9. Removed int main()
//
...
class UnoDeck
{
    static inline bool seeded = false;  // C++17 inline static
...
class GameManager
{
    static inline GameManager* instance = nullptr;  // C++17 inline static
